            ...
            for airport in self.airports:
                if airport in self.mos_dict:
                    ...
                    if stationId in stationiddict:
                        debugging.info(f"{stationId} Duplicate, only saved first metar category")
                    else:
    ...
    def wx_display_loop(self, stationiddict, windsdict, wxstringdict, toggle):
        ...
        for cycle_num in self.cycles:
            ...
            for airport_key in airport_list:
                ...
                if self.conf.get_bool("default", "legend") and airportcode == "LGND" and (airportled in self.legend_pins):
                    ...
                    if airportled == self.conf.get_int("lights", "leg_pin_hiwinds") and self.conf.get_int("lights", "legend_hiwinds"):
                        if cycle_num in (3, 4, 5):
                            color = colors.black()
                        else:
                            color = colors.IFR(self.conf)

                    if airportled == self.conf.get_int("lights", "leg_pin_lghtn") and self.conf.get_int("lights", "legend_lghtn"):
                    ...
                    if airportled == self.conf.get_int("lights", "leg_pin_snow") and self.conf.get_int("lights", "legend_snow"):
                    ...
                    if airportled == self.conf.get_int("lights", "leg_pin_rain") and self.conf.get_int("lights", "legend_rain"):
                    ...
                    if airportled == self.conf.get_int("lights", "leg_pin_frrain") and self.conf.get_int("lights", "legend_frrain"):
                    ...
                    if airportled == self.conf.get_int("lights", "leg_pin_dustsandash") and self.conf.get_int("lights", "legend_dustsandash"):
                    ...
                    if airportled == self.conf.get_int("lights", "leg_pin_fog") and self.conf.get_int("lights", "legend_fog"):
                ...
                if airportled == self.conf.get_int("lights", "homeport_pin") and self.conf.get_bool("lights", "homeport") and toggle:
                ...
                if airportled == self.conf.get_int("lights", "homeport_pin") and self.conf.get_bool("lights", "homeport"):
